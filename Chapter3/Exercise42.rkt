...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise42) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define (render ws)
  (if (> (x-coordinate ws)
         (- WIDTH-OF-WORLD
            (/ (length-car CAR)
               2)))
      (place-image tree 100 Y-CAR BACKGROUND)
      (place-image CAR (x-coordinate ws) Y-CAR BACKGROUND)))
